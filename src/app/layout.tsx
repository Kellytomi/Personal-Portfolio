  ...
  return (
    <html lang="en" className={`${jakarta.variable} ${syne.variable}`}>
      <head>
        ...
        <meta
          property="og:title"
          content="Etoma-etoto Kelvin Odi | Fullstack Developer & Workflow Automation Specialist"
        />
        <meta
        ...
        <meta
          ...
          content="Professional portfolio of Etoma-etoto Kelvin Odi, a specialist in web development and workflow automation"
        />
        <meta
          name="twitter:image"
          content={`${siteUrl}/opengraph-image`}
