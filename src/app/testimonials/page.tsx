...
export default function Testimonials(): JSX.Element {
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quote:
        'The workflow automation solution implemented by Kelvin has transformed our operations. We have seen a 40% increase in efficiency and significant time savings across departments.',
    ...
    },
    {
      ...
      quote:
        'The yacht website project exceeded our expectations. The real-time data integration and elegant design have significantly improved our customer engagement.',
    ...
    },
    {
      ...
      quote:
        'The marketing asset automation system has streamlined our content creation process. We can now generate and distribute materials in a fraction of the time.',
    ...
    },
    {
      ...
      quote:
        "Kelvin's expertise in Flutter development helped us create a robust subscription tracking app that our users love. The attention to detail and user experience is outstanding.",
    ...
    },
    {
      ...
      quote:
        'The PandaDoc CRM integration has revolutionized our sales process. We can now generate and track proposals automatically, saving countless hours of manual work.',
    ...
    },
    {
      ...
      quote:
        'The proposal templates and brand kit design have given our agency a professional edge. The automated workflow has made our client onboarding process seamless.',
  ...
  const industries = [
    'All',
    ...Array.from(new Set(testimonials.map((t) => t.industry).filter(Boolean) as string[])),
  ];
    ...
    <PageTransition>
      <main className="min-h-screen bg-surface overflow-hidden" ref={containerRef}>
        ...
        <section className="pt-32 pb-16 relative">
          <motion.div className="absolute inset-0 bg-[url('/grid.svg')] opacity-5" style={{ y }} />
          ...
          <div className="container relative">
            ...
            >
              ...
              <p className="text-lg text-muted max-w-2xl mx-auto leading-relaxed">
                Real results from real clients. Discover how my solutions have transformed
          ...
          <div className="container">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                My solutions deliver measurable impact for businesses across industries. Here's the
                quantifiable difference I've made for my clients.
              </p>
            </motion.div>
            ...
            >
              <div className="bg-primary text-white p-8 md:p-12 rounded-xl">
                ...
                <p className="text-lg mb-8 max-w-2xl mx-auto">
                  Let's discuss how my expertise can help solve your challenges and achieve your
                  business goals.
                </p>
                <Link
                  href="/contact"
